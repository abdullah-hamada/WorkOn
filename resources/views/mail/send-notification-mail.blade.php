        ...
        <td style="padding:20px 20px">
            <table width="100%" style="border-spacing: 0px;width:100%;margin-bottom: 10px;">
                ...
                @if(isset($data['task']) && !empty($data['task']))
                    <tr>
                        لم يتم تسليم التقرير وعليك تسليم التقرير للمهمة: {{$data['task']['name']}}
                    </tr>
                ...
                @if(isset($data['link']))
                    <tr>
                        <td style="text-align:center;color:#f7f7f7">
                            <a href="{{$data['link']}}"
                               style="text-decoration: none;cursor: pointer;cursor: pointer;display: inline-block; padding: 12px 34px; background-color: #1b56aa; border-radius: 5px; color: #fff; font-size: 16px; font-weight: 500;font-family:'Roboto'">{{__('message.click')}}
                            </a>
                        </td>
                    </tr>
                @endif
