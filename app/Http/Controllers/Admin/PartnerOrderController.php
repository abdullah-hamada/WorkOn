...
class PartnerOrderController extends Controller
{
    ...
    {
        return Inertia::render('views/admin/PartnerOrder/Index', [
            'partners_order' => PartnerOrder::with('country')->orderBy('id', 'desc')->get()
        ]);
    }
    ...
    public function show($id)
    {
        ...
        return Inertia::render('views/admin/PartnerOrder/Show', [
