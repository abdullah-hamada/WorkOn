  ...
  data: function data() {
    return {
      ...
      partner_order_items: [{
        ...
        name: 'مجال العمل  ',
        icon: 'mdi-rename',
        text: this.partner_order.employment_filed
      }, {
        name: 'التصنيف  ',
                            ...
                            [
                              _c("v-col", [
                                _c("h4", [
                                  _vm._v(
                                    "\n                  بيانات الشريك (\n                  " +
                                      _vm._s(_vm.partner_order.company_name) +
                                      "\n                  )\n                "
                                  ),
                                ]),
                              ]),
