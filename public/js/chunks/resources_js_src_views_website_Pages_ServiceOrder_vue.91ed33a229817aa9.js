...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _layouts_website_layout_layout__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../layouts/website_layout/layout */ "./resources/js/src/layouts/website_layout/layout.vue");
//
//
//
//
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: "Partner",
  layout: _layouts_website_layout_layout__WEBPACK_IMPORTED_MODULE_0__["default"],
  props: {
    countries: Array,
  ...
  methods: {
    submit: function submit() {
      this.form.post('/save_company_service_order', {
            ...
            [
              ...
              _c(
                ...
                [
                  _c("v-select", {
                    attrs: {
                      "error-messages": _vm.$page.props.errors.age_group,
                      items: _vm.age_groups,
                      "item-text": "name",
                      "item-value": "id",
                      label: "الفئة العمرية",
                      outlined: "",
              ...
              _c(
                ...
                [
                  _c("v-text-field", {
                    attrs: {
                      "error-messages": _vm.$page.props.errors.training_time,
                      label: "مدة التدريب",
                      outlined: "",
                      "prepend-icon": "mdi-counter",
                    },
                    model: {
                      value: _vm.form.training_time,
                      callback: function ($$v) {
                        _vm.$set(_vm.form, "training_time", $$v)
                      },
                      expression: "form.training_time",
                    },
                  }),
                ],
                1
              ...
              _c(
                ...
                [
                  _c("v-textarea", {
                    attrs: {
                      "error-messages":
                        _vm.$page.props.errors.service_description,
                      label: "اشرح لنا باختصار عن الخدمة المطلوبة",
                      outlined: "",
                      "prepend-icon": "mdi-text",
                    },
                    model: {
                      ...
                      callback: function ($$v) {
                        _vm.$set(_vm.form, "service_description", $$v)
                      },
