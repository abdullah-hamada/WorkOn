  ...
  methods: (_methods = {
    ...
    previewPrizeImage: function previewPrizeImage(event, index) {
      ...
      if (input.files && input.files[0]) {
        ...
        reader.onload = function (e) {
          _this11.form.prize_section_item.preview_image = e.target.result;
          _this11.form.prize_section_item.image = input.files[0];
        };
    ...
    previewPartnerImage: function previewPartnerImage(event, index) {
      ...
      if (input.files && input.files[0]) {
        ...
        reader.onload = function (e) {
          _this12.form.partner_items[index].preview_image = e.target.result;
          _this12.form.partner_items[index].image = input.files[0];
        };
