  ...
  data: function data() {
    return {
      form: this.$inertia.form({
        ...
        about_us_items: this.about_us_items,
        prize_section_item: this.prize_section_item,
        partner_items: this.partner_items,
        partner_section: this.partner_section,
  ...
  methods: {
    ...
    previewSliderImage: function previewSliderImage(event, index) {
      ...
      if (input.files && input.files[0]) {
        ...
        reader.onload = function (e) {
          _this.form.slider_items[index].preview_image = e.target.result;
          _this.form.slider_items[index].image = input.files[0];
        };

        reader.readAsDataURL(input.files[0]);
      }
    },
    previewAboutUsImage: function previewAboutUsImage(event) {
      var _this2 = this;
      ...
      if (input.files && input.files[0]) {
        ...
        reader.onload = function (e) {
          _this2.form.about_us_image.preview_image = e.target.result;
          _this2.form.about_us_image.image = input.files[0];
        };
    ...
    previewPrizeImage: function previewPrizeImage(event, index) {
      ...
      if (input.files && input.files[0]) {
        ...
        reader.onload = function (e) {
          _this3.form.prize_section_item.preview_image = e.target.result;
          _this3.form.prize_section_item.image = input.files[0];
        };
    ...
    previewPartnerImage: function previewPartnerImage(event, index) {
      ...
      if (input.files && input.files[0]) {
        ...
        reader.onload = function (e) {
          _this4.form.partner_items[index].preview_image = e.target.result;
          _this4.form.partner_items[index].image = input.files[0];
        };
    ...
    add_new_partner_item: function add_new_partner_item() {
    ...
    deleteSocialMediaItem: function deleteSocialMediaItem(index) {
      this.form.social_media_items.splice(index, 1);
    },
    deleteAboutUsItem: function deleteAboutUsItem(index) {
      this.form.about_us_items.splice(index, 1);
    },
    deletePartnerItem: function deletePartnerItem(index) {
                                                        ...
                                                        _c("input", {
                                                          ...
                                                          on: {
                                                            change: function (
                                                              ...
                                                              return _vm.previewAboutUsImage(
                                                                $event
                                                              )
                                                            },
                                                          },
                                                  ...
                                                  [
                                                    _c("v-text-field", {
                                                      ...
                                                      model: {
                                                        ...
                                                        expression:
                                                          "form.prize_section_item.sub_title",
                                                      },
                                                    }),
                                                  ],
                                                  1
                                                    ...
                                                    _c("v-text-field", {
                                                      attrs: {
                                                        ...
                                                        "error-messages":
                                                          _vm.$page.props
                                                            .errors[
                                                            "prize_section_item.sub_title_2"
                                                          ],
                                                        outlined: "",
                                                        placeholder:
                                                          " العنوان الفرعي الثاني",
                                                      ...
                                                      model: {
                                                        ...
                                                        expression:
                                                          "form.prize_section_item.sub_title_2",
                                                      },
                                                    }),
                                                  ],
                                                  1
                                                    ...
                                                    _c("v-text-field", {
                                                      attrs: {
                                                        "error-messages":
                                                          _vm.$page.props
                                                            .errors[
                                                            "prize_section_item.button_text"
                                                          ],
                                                        dense: "",
                                                        label: "عنوان الزر",
                                                        outlined: "",
                                                      ...
                                                      model: {
                                                        ...
                                                        expression:
                                                          "form.prize_section_item.button_text",
                                                      },
                                                    }),
                                                  ],
                                                  1
                                                  ...
                                                  [
                                                    _c("v-text-field", {
                                                      ...
                                                      model: {
                                                        ...
                                                        expression:
                                                          "form.prize_section_item.button_url",
                                                      },
                                                    }),
                                                  ],
                                                  1
                                                ...
                                                [
                                                  _c("v-textarea", {
                                                    ...
                                                    model: {
                                                      ...
                                                      expression:
                                                        "form.partner_section.paragraph",
                                                    },
                                                  }),
                                                ],
                                                1
