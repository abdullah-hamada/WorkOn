...
@php
 ...
 //    ])->to('before_content')->makeFirst();
    ...
    $productCount = App\Models\Company_job::count();
    $userCount = \App\Models\User::count();
    $articleCount =\App\Models\User::count();
    $lastArticle = \App\Models\User::orderBy('id', 'DESC')->first();
    ...
    Widget::add()->to('before_content')->type('div')->class('row')->content([
        ...
        Widget::make()
            ...
            ->value($talent_count)
            ->description('مستخدمي المنصة')
            ->progress(100*(int)$talent_count/1000),
        ...
        Widget::add()
            ...
            ->value($company_count)
            ->description('الشركات')
            ->progress(100*(int)$company_count/1000)
            ->onlyHere(),
        ...
        Widget::make()
            ...
            ->progress(100*(int)$employee_count/1000)
            ,
    ...
    $widgets['before_content'][] = [
      ...
      'content' => [ // widgets
              [
                ...
                'content' => [
                    'header' => 'عدد المستخدمين المسجلين في الفترة الاخيرة', // optional
