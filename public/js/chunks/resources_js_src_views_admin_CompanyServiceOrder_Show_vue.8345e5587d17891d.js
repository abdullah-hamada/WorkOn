  ...
  data: function data() {
    return {
      ...
      service_order_items: [{
        ...
        text: this.company_service_order.category.name
      }, {
        name: 'السلوجن  ',
        icon: 'mdi-tag-text',
