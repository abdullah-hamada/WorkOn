              ...
              <v-row class="justify-space-between  px-2 px-lg-3">
                ...
                <v-col
                  ...
                  <div class="d-flex align-center ml-3">
                    <v-btn
                      color="success"
                      @click="$inertia.get('/dashboard/partner/edit_order_info' )">
                      <v-icon class="ml-1" color="white">mdi-check-circle</v-icon>
                      تعديل
                    </v-btn>
                    <v-btn :loading="progress"
                           class="mx-2" color="red"
                           @click="cancel_order_request()">
                      <v-icon class="ml-1" color="white">mdi-cancel</v-icon>
                      طلب الغاء الشراكة
                    </v-btn>
                  </div>
                </v-col>
  ...
  methods: {
    cancel_order_request() {
      swal({
        ...
        if (result == 1) {
          this.progress = true
          this.$inertia.get('/dashboard/partner/cancel_order_request', {
            onSuccess: page => {
              this.progress = false
            },
          })
