                ...
                <v-card>
                  ...
                  >
                    ...
                    <template #[`item.actions`]="{item}">
                      <v-tooltip v-if="item.status==3" bottom color="green">
                      ...
                      <v-tooltip v-if="item.status==3" bottom color="red">
                        <template v-slot:activator="{ on, attrs }">
                          <v-icon
                            class="mr-2"
                            color="red"
                      ...
                      <v-tooltip v-if="item.status==1" bottom color="green">
                        <template v-slot:activator="{ on, attrs }">
                          <v-icon
                            class="mr-2"
                            color="green"
                      ...
                      <v-tooltip v-if="item.status==2" bottom color="red">
                        <template v-slot:activator="{ on, attrs }">
                          <v-icon
                            class="mr-2"
                            color="red"
