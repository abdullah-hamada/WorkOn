...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: (_methods = {
    ...
    previewSectionTwelveImage: function previewSectionTwelveImage(event, index) {
      ...
      if (input.files && input.files[0]) {
        ...
        reader.onload = function (e) {
          _this9.form.section_six_items[index].preview_image = e.target.result;
          _this9.form.section_six_items[index].image = input.files[0];
        };
  ...
  }, (0,D_laragon_www_work_net_project_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_methods, "add_new_section_six_item", function add_new_section_six_item() {
    this.form.section_six_items.push({
      title: null,
      sub_title: null,
      image: null,
