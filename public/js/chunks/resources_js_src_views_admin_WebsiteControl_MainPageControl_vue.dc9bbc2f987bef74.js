...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: (_methods = {
    ...
    previewPartnerItemImage: function previewPartnerItemImage(event, index) {
      var _this2 = this;
      ...
      if (input.files && input.files[0]) {
        ...
        reader.onload = function (e) {
          _this2.form.section_three_items[index].preview_image = e.target.result;
          _this2.form.section_three_items[index].image = input.files[0];
        };
    ...
    previewSectionOneImage: function previewSectionOneImage(event) {
      ...
      if (input.files && input.files[0]) {
        ...
        reader.onload = function (e) {
          _this3.form.section_one_item.preview_image = e.target.result;
          _this3.form.section_one_item.image = input.files[0];
        };
    ...
    previewSliderImage: function previewSliderImage(event, index) {
      ...
      if (input.files && input.files[0]) {
        ...
        reader.onload = function (e) {
          _this4.form.slider_items[index].preview_image = e.target.result;
          _this4.form.slider_items[index].image = input.files[0];
        };
    ...
    previewSectionTwoImage: function previewSectionTwoImage(event) {
      ...
      if (input.files && input.files[0]) {
        ...
        reader.onload = function (e) {
          _this5.form.section_two_item.preview_image = e.target.result;
          _this5.form.section_two_item.image = input.files[0];
        };
    ...
    previewSectionFourImage: function previewSectionFourImage(event) {
      ...
      if (input.files && input.files[0]) {
        ...
        reader.onload = function (e) {
          _this6.form.section_four_item.preview_image = e.target.result;
          _this6.form.section_four_item.image = input.files[0];
        };
    ...
    previewSectionNineImage: function previewSectionNineImage(event) {
      ...
      if (input.files && input.files[0]) {
        ...
        reader.onload = function (e) {
          _this7.form.section_nine_item.preview_image = e.target.result;
          _this7.form.section_nine_item.image = input.files[0];
        };
    ...
    previewSectionTenImage: function previewSectionTenImage(event, index) {
      ...
      if (input.files && input.files[0]) {
        ...
        reader.onload = function (e) {
          _this8.form.section_ten_items[index].preview_image = e.target.result;
          _this8.form.section_ten_items[index].image = input.files[0];
        };
    ...
    previewSectionElevenImage: function previewSectionElevenImage(event) {
      ...
      if (input.files && input.files[0]) {
        ...
        reader.onload = function (e) {
          _this9.form.section_eleven_item.preview_image = e.target.result;
          _this9.form.section_eleven_item.image = input.files[0];
        };
    ...
    previewSectionTwelveImage: function previewSectionTwelveImage(event, index) {
      ...
      if (input.files && input.files[0]) {
        ...
        reader.onload = function (e) {
          _this10.form.section_twelve_items[index].preview_image = e.target.result;
          _this10.form.section_twelve_items[index].image = input.files[0];
        };
    ...
    previewSectionFiveImage: function previewSectionFiveImage(event, index) {
      ...
      if (input.files && input.files[0]) {
        ...
        reader.onload = function (e) {
          _this11.form.section_five_items[index].preview_image = e.target.result;
          _this11.form.section_five_items[index].image = input.files[0];
        };
    ...
    previewSectionSixImage: function previewSectionSixImage(event, index) {
      ...
      if (input.files && input.files[0]) {
        ...
        reader.onload = function (e) {
          _this12.form.section_six_items[index].preview_image = e.target.result;
          _this12.form.section_six_items[index].image = input.files[0];
        };
    ...
    previewSectionSevenImage: function previewSectionSevenImage(event, index) {
      ...
      if (input.files && input.files[0]) {
        ...
        reader.onload = function (e) {
          _this13.form.section_seven_items[index].preview_image = e.target.result;
          _this13.form.section_seven_items[index].image = input.files[0];
        };
    ...
    previewPrizeImage: function previewPrizeImage(event, index) {
      ...
      if (input.files && input.files[0]) {
        ...
        reader.onload = function (e) {
          _this14.form.prize_section_item.preview_image = e.target.result;
          _this14.form.prize_section_item.image = input.files[0];
        };
    ...
    previewPartnerImage: function previewPartnerImage(event, index) {
      ...
      if (input.files && input.files[0]) {
        ...
        reader.onload = function (e) {
          _this15.form.partner_items[index].preview_image = e.target.result;
          _this15.form.partner_items[index].image = input.files[0];
        };
